...
<head>
    <title>Code coverage report for fabric-shim/lib/stub.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">fabric-shim/lib</a> stub.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">100% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>243/243</span>
            </div>
...
<a name='L1115'></a><a href='#L1115'>1115</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
function computeProposalBinding(decodedSP) {
    ...
    const creator = fabprotos.msp.SerializedIdentity.encode(decodedSP.proposal.header.signatureHeader.creator).finish();
...
class ChaincodeStub {
    ...
    constructor(client, channel_id, txId, chaincodeInput, signedProposal) {
        ...
        this.txId = txId;
        this.bufferArgs = chaincodeInput.args.map((arg) =&gt; Buffer.from(arg));
